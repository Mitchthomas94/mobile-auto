  ...
  return (
    <>
      ...
      <section className="container mt2">
        ...
        {/* Responsive grid — 3 columns on desktop, stacked rows on mobile */}
        ...
        <style jsx>{`
          ...
          /* Mobile: rows with comfortable spacing */
          @media (max-width: 860px) {
            .pricing-grid {
              grid-template-columns: 1fr;
              gap: 1.25rem;
            }
            /* Ensure long text never spills */
            :global(.card) {
              min-width: 0;
            ...
            /* Buttons full width on mobile for tidy look */
            :global(.card .btn) {
              width: 100%;
